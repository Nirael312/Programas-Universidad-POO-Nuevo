public class App_final {
    ...
    public static void main(String[] args) {
        ...
        Persona persona1 = new Persona("Ariel", 19, true, false);
        Persona persona2 = new Persona("Noelia", 25, true, false);
        Persona persona3 = new Persona("Elsa", 55, false, true);

        Persona persona4 = new Persona("Walter", 24, true, false);
        Persona persona5 = new Persona("Selena", 20, true, true);
